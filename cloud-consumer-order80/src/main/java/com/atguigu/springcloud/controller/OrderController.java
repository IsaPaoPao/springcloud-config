...
public class OrderController {
    ...
    public CommonResult<Payment> getPayment(@RequestParam Long id){
        ...
        return restTemplate.getForObject(PAYMENT_URL + "/payment/get/id?id=" + id ,CommonResult.class);
    }
    @GetMapping("/consumer/payment/getForEntity/id")
    public CommonResult<Payment> getPayment2(@RequestParam("id") Long id){
        ResponseEntity<CommonResult> entity = restTemplate.getForEntity(PAYMENT_URL + "/payment/get/id?id=" + id ,CommonResult.class);
